...
# matrix size
n=16
convert_files=("setup_result.txt" "weight_matrix.txt" "original_matrix.txt" "result_matrix.txt")
...
python3 converter_weight_fifo.py ./hex/weight_matrix_hex.txt ./hex/weight_matrix_concat.txt 16